...
public class AluguelDTO {
	...
	public AluguelDTO(Aluguel corridas) {
		this.emailCondutor = corridas.getCondutor().getEmail();
		this.ativa = corridas.isAtivo();
	...
	public static List<AluguelDTO> converter(List<Aluguel> corridas) {
		
		return corridas.stream().map(AluguelDTO::new).collect(Collectors.toList());
